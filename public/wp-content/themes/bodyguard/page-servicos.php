       ...
       while (have_posts()) : the_post(); ?>    
  			<article>
  				<div class="body field">
  					<?php // the_content(); ?>
            <div style="background-image: url('/wp-content/uploads/2015/07/service-3.jpg'); height: 200px; width: 100%; margin-top: -30px; background-size: cover; background-position-y: -30px; background-repeat: no-repeat; margin-bottom: 30px;" /></div>
